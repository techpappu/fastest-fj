                ...
                <?php if ( have_posts() ) : ?>
                    ...
                    <div class="mt-10">
                        ...
                        the_posts_pagination( array(
                            ...
                            'before_page_number' => '<span class="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-brand-gold hover:text-white hover:border-brand-gold transition inline-flex mx-1">',
